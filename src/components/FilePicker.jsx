...
function FilePicker(props) {
  ...
  const checklistData = [
    ...
    { id: 0, label: "Observation Start Date"},
    { id: 0, label: "Obseration End Date"},
            ...
            <ListItem key={"personID"}>
              <Grid container alignItems="center" spacing={1}>
                ...
                <Grid item>
                  ...
                  <Checkbox
                    checked={isPersonIDAutoGenerated}
                    onChange={(e) =>
                      setIsPersonIDAutoGenerated(e.target.checked)
                    }
                  />
                </Grid>
                ...
                <Grid item style={{ width: 240 }}>
                  ...
                  {isPersonIDAutoGenerated ? (
                    <div />
                  ) : (
                    <TextField label="Specify ID key in data" fullWidth />
                  )}
                </Grid>
              </Grid>
            </ListItem>
